...
[![Build Status](https://travis-ci.com/enixdark/go-gecko.svg?branch=master)](https://travis-ci.com/enixdark/go-gecko) [![GoDoc](https://godoc.org/github.com/superoo7/go-gecko?status.svg)](https://godoc.org/github.com/superoo7/go-gecko)
...
```
go get -u github.com/enixdark/go-gecko
```
...
import (
	...
	coingecko "github.com/enixdark/go-gecko/v3"
)
